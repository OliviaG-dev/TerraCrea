...
describe("HomeScreen - Tests Complets", () => {
  ...
  it("devrait avoir des mocks fonctionnels", async () => {
    ...
    const header = CommonHeader({ title: "Accueil" });
    ...
    expect(header.props.testID).toBe("header-accueil");
  ...
  it("devrait avoir des services mockés", async () => {
    const { getCreations, getCreationsByCategory, searchCreations } =
  ...
  it("devrait gérer les headers avec des testIDs appropriés", async () => {
    ...
    const homeHeader = CommonHeader({ title: "Accueil" });
    const welcomeHeader = CommonHeader({ title: "Bienvenue" });

    expect(homeHeader.props.testID).toBe("header-accueil");
    expect(welcomeHeader.props.testID).toBe("header-bienvenue");
  });
